...
class PasswordPoliciesFieldTest(BaseTest):
    ...
    def test_password_field_4(self):
        self.assertFieldOutput(PasswordPoliciesField,
                               {'Chad+pher9k': 'Chad+pher9k'},
                               {'aaaa5+56dddddd': ['The new password contains consecutive characters. Only 3 consecutive characters are allowed.',
    ...
    def test_password_field_5(self):
        self.assertFieldOutput(PasswordPoliciesField,
                               {'Chad+pher9k': 'Chad+pher9k'},
                               {'someone2@example.com': ['The new password is not varied enough.',
    ...
    def test_password_field_6(self):
        self.assertFieldOutput(PasswordPoliciesField,
                               ...
                               {'\xc1\xc2\xc3\xc4\u0662\xc5\xc6': ['The new password must contain 1 or more symbol.']}
                               )

    def test_password_field_7(self):
        self.assertFieldOutput(PasswordPoliciesField,
                               {'Ch\xc4d+pher9k': 'Ch\xc4d+pher9k'},
                               {'\xc1\xc2\xc3\xc4\u0662\xc5\u20ac': ['Ensure this value has at least 8 characters (it has 7).']},
